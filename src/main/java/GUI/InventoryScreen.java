    ...
    public void renderScreen(ImageHandler renderer, int ScreenWidth, int ScreenHeight) {
        ...
        for(GUIInventorySlot CurrentSlot : InventorySlots) { //Jeden Slot durchgehen
            ...
            if(CurrentItem != null) { //Wenn im Momentanen Slot ein Item ist
                ...
                renderer.drawFull(CurrentItem.getTextureID(), CurrentSlot.PosX - Camera.PosX, CurrentSlot.PosY - Camera.PosY, CurrentSlot.SlotSize, CurrentSlot.SlotSize);
            }
        }
        ...
        if(HeldItem != null) { // Wenn wir gerade ein Item mit der Cursor festhalten
            ...
            renderer.drawFull(HeldItem.getTextureID(), (float)Mouse.PosX - HeldItem.getTextureWidth() / 2 - Camera.PosX, (float)Mouse.PosY - HeldItem.getTextureWidth() / 2 - Camera.PosY, PickedUpItemSize, PickedUpItemSize);
        }
    }
