...
public class Save { //Klasse um Daten zu speichern
    public static void SaveData(PhysicsObject2D player, String PATH) {
    ...
    public static PhysicsObject2D LoadObjectData() {
        try (FileInputStream fileIn = new FileInputStream("gamesession/Playerdata/Player.ser"); //Öffnet die Datei um Bytes davon zu lesen
