...
public class HudHandler {
    ...
    public static void PlaceNewBar(int PosX, int PosY, int BarLength, int BarHeight, int TextureID, int BarDamage, int BarOffsetX, int BarOffsetY, Color BarColor) {
        BarElement bar = new BarElement(PosX, PosY, BarLength, BarHeight, TextureID, BarDamage, BarOffsetX, BarOffsetY, BarColor); //Erstellt nen neues BarElement mit den Reingegebenen Variablen
