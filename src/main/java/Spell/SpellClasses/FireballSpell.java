...
public class FireballSpell extends Spell {
    ...
    public static float FIREBALL_SPELL_MAX_TRAVEL_DISTANCE = 1000;
    public static float FIREBALL_SPELL_SPLASHDAMAGE_RADIUS = 20;
            ...
            for (Enemy CurrentEnemy1 : Enemy.Enemies) {
                if (CurrentEnemy1.PosX <= ThisProjectile.PosX && CurrentEnemy1.PosX + CurrentEnemy1.ObjLength >= ThisProjectile.PosX && CurrentEnemy1.PosY <= ThisProjectile.PosY && CurrentEnemy1.PosY + CurrentEnemy1.ObjHeight >= ThisProjectile.PosY) {
                    ...
                    for (Enemy CurrentEnemy2 : Enemy.Enemies) {
                        if (CurrentEnemy2.PosX <= ThisProjectile.PosX + FIREBALL_SPELL_SPLASHDAMAGE_RADIUS && CurrentEnemy1.PosX + CurrentEnemy1.ObjLength >= ThisProjectile.PosX + FIREBALL_SPELL_SPLASHDAMAGE_RADIUS && CurrentEnemy1.PosY <= ThisProjectile.PosY + FIREBALL_SPELL_SPLASHDAMAGE_RADIUS && CurrentEnemy1.PosY + CurrentEnemy1.ObjHeight >= ThisProjectile.PosY + FIREBALL_SPELL_SPLASHDAMAGE_RADIUS) {
