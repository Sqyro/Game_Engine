...
import Spell.SpellClasses.LightningballSpell;
...
public class Spells {
    ...
    public static void RegisterSpells() {
        ...
        SPELLS.register(new LightningballSpell(ImageManager.SWORD, 32, 32, ImageManager.LIGHTNINGBALL_SPELL_ANIM, 64, 64, "lightningball", 3));
